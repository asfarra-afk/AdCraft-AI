...
import { Sparkles, Bookmark, Zap, Globe, Palette } from 'lucide-react';
      ...
      <div className="max-w-7xl mx-auto flex flex-col sm:flex-row items-center justify-between gap-3">
        ...
        <div className="flex items-center gap-2.5 w-full sm:w-auto justify-end flex-wrap">
          ...
          <div className="flex items-center bg-slate-800/90 border border-slate-700/80 rounded-lg p-1 text-xs">
            ...
            >
              <option value="midnight" className="bg-slate-900 text-white">🌃 Midnight Blue (মিডনাইট)</option>
              <option value="emerald" className="bg-slate-900 text-white">🌲 Dark Emerald (এমারেল্ড)</option>
              <option value="slate" className="bg-slate-900 text-white">🖤 Dark Slate (স্লেট)</option>
              <option value="light" className="bg-slate-900 text-white">☀️ Clean Light (লাইট মোড)</option>
            </select>
          </div>
